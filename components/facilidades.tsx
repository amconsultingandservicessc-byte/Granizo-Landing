import { Banknote, Landmark, Building2 } from "lucide-react"
      ...
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        <Reveal>
          ...
          <p className="mt-3 text-emerald-100/90">
            Aceptamos distintas formas de pago para que hagas tuya esta
            residencia.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.2}>
          <div className="mt-12 rounded-2xl border border-emerald-300/30 bg-emerald-500/10 p-8">
            <p className="text-balance text-xl font-bold text-emerald-300 sm:text-2xl">
              ¿No sabes cuánto te prestan? Te ayudamos a tramitar tu crédito
              bancario ¡SIN COSTO!
            </p>
            <a
              href={PREAPRUEBA_URL}
